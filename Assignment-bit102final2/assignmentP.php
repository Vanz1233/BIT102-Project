...
<body>
    ...
    <div class="signup-bar">
        <?php
            ...
            if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
                echo '<a href="profile.php" class="signup-link">Account</a>&nbsp;&nbsp;';
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="PrivateSales.php">Private Sales</a>
                    </li>
                    <li class="nav-item">
                ...
                <form class="d-flex" onsubmit="handleSearch(event)" action="searching.php">
    ...
    <section class="hero-section">
        ...
        <div class="btn-group btn-group-lg d-flex justify-content-center mt-4" role="group" aria-label="Large button group">
            <a href="Auction.html" class="btn btn-primary mx-2">Browse</a>
            <a href="Selling.html" class="btn btn-primary mx-2">Sell</a>
        </div>
    </section>
    <hr>
    ...
    <section class="item-section">
        ...
        <div class="scroll-container">
            <div class="card">
                <a href="Tissot2.html">
                    <img src="https://www.tissotwatches.com/media/catalog/product/T/1/T127.407.16.041.01_R.png?im=Resize=(387,387)">
                    <div class="text-container">
            ...
            <div class="card">
                <a href="Women1.html">
                    <img src="https://solartime.com/cdn/shop/products/BNB10728-2567S_TECH.png?v=1676963430&width=600" alt="Avatar">
                    <div class="text-container">
            ...
            <div class="card">
                <a href="Tissot3.html">
                    <img src="https://www.tissotwatches.com/media/catalog/product/T/1/T150.417.11.051.00_R_1.png?im=Resize=(387,387)" alt="Avatar">
                    <div class="text-container">
            ...
            <div class="card">
                <a href="Women3.html">
                    <img src="https://solartime.com/cdn/shop/files/NORCIA_CIWLG0008801_2f2206b4-fdb6-45f1-8051-7d05ece0311a.jpg?v=1707354469&width=600" alt="Avatar">
                    <div class="text-container">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-md-6">
                    <div class="buy-now-content">
                        <a href="Auction.html" class="buy-now-link">
                        ...
                        <div class="buy-now-action">
                            <a href="PrivateSales.php" class="buy-now-button">BROWSE PRIVATE SALES</a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6">
