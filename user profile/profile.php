       ...
       <div class="col-6 col-sm-4 col-md-3">
        ...
        <div class="col-6 col-sm-4 col-md-3">
                    <div class="icon-container">
                        ...
                        <button class="btn default icon-btn" onclick="location.href='setting.html';">Edit Account Information</button>
                    </div>

                    <div class="col-6 col-sm-4">
                    <div class="icon-container">
                        <img src="preferencesicon.jpeg" alt="Avatar" class="icon-img">
                        <button class="btn default icon-btn" onclick="location.href='Communication.html';">User Preferences</button>
                    </div>
                </div>
                </div>
    </div>
